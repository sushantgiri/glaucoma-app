...
def main():
    ...
    with left_col:
        ...
        # ✅ NEW: persistent placeholders under the button
    ...
    if image is not None and st.session_state.run_requested:
        # ✅ NEW: clear previous errors for a fresh run
        ...
        try:
            ...
            # Step 1: Prediction ✅ CHANGED: show validation errors in error_placeholder (persistent)
            ...
            with status_placeholder.container():
                with st.spinner("🔄 Analysing image with DenseNet121…"):
                    try:
                        ...
                        error_placeholder.error(str(e))  # ✅ CHANGED (persistent)
                        # keep UI clean but do NOT clear error_placeholder
                        progress_wrap.empty()
                ...
                with status_placeholder.container():
                    with st.spinner("🧠 Generating DenseNet121 Grad-CAM…"):
                        try:
                            ...
                            cam_path = None
                            error_placeholder.warning(str(e))  # ✅ CHANGED (persistent warning)
